...
public final class PlanDeEstiba {
    ...
    private PlanDeEstiba(Builder builder) {
    ...
    public String toString() {
        ...
        sb.append("Total weight: ").append(String.format("%.2f", totalWeight)).append(" tons\n");
        sb.append("Imbalance: ").append(String.format("%.2f", imbalancePercent)).append("%\n");
        sb.append("Tons to transfer: ").append(String.format("%.2f", tonsToTransfer)).append(" tons\n");
        sb.append("Draft: ").append(String.format("%.2f", draft)).append(" m\n");
